...
The current reviewed pin is `0efe24e454c62450ee5739384031c24cc3242f97`, including
the WP00.02 declaration profile and Android licence closure, plus the WP00.03
source, documentation-resource and native-distribution provenance profiles. The original WP00.01 collection and
...
9,453 explicit rule citations, checks 11,442 local links and validates 166 exact
